...
from contact.views import EmergencyDetailsDelete, EmergencyDetailsDetails, \
    UserEmergencyDetailsList, EmergencyDetailsList
...
urlpatterns = [
    ...
    path('viewonly', UserEmergencyDetailsList.as_view(), name='useremergencyDetails_list'),
]
